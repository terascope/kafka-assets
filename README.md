...
|       **max_poll_interval**       |                                  `duration`                                   | `"5 minutes"`  |                                     The maximum delay between invocations of poll() when using consumer group management. This places an upper bound on the amount of time that the consumer can be idle before fetching more records. If poll() is not called before expiration of this timeout, then the consumer is considered failed and the group will rebalance in order to reassign the partitions to another member.                                     |
...
|             **wait**              |                                  `duration`                                   | `"30 seconds"` |                                                                                                                                                                                      How long to wait for a full chunk of data to be available. Specified in milliseconds.                                                                                                                                                                                       |
...
|       **metadata_refresh**        |                      `duration`                      | `"5 minutes"` |                                                                                                                                                                               How often the producer will poll the broker for metadata information. Set to -1 to disable polling.                                                                                                                                                                                |
| **partition_assignment_strategy** |           `"range"`, `"roundrobin"`, `""`            |       -       |                                                                                                                                                                           Name of partition assignment strategy to use when elected group leader assigns partitions to group members.                                                                                                                                                                            |
|         **required_acks**         |                        `int`                         |      `1`      |                                                                                                                                                                                      The number of required broker acknowledgements for a given request, set to -1 for all.                                                                                                                                                                                      |
|             **size**              |                       `Number`                       |    `10000`    |                                                                                                                                                                                                  How many messages will be batched and sent to kafka together.                                                                                                                                                                                                   |
