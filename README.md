...
| **group**               | `String`                                                                      | N/A          | Name of the Kafka consumer group                                                                                                                                                                                                                                                                                                                                                        |
...
| **id_field**         | `String`                                             | N/A         | Field in the incoming record that contains keys                                                     |
...
| **timestamp_field**  | `String`                                             | N/A         | Field in the incoming record that contains a timestamp to set on the record                         |
| **timestamp_now**    | `Boolean`                                            | `undefined` | Set to true to have a timestamp generated as records are added to the topic                         |
| **topic**            | `String`                                             | N/A         | Name of the Kafka topic to send data to                                                             |
